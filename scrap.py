...
output_path = "/Users/maksim/PycharmProjects/smoking_detection"
...
if __name__ == '__main__':
    term = input("What would you like to download?\n")
    number_of_images = int(input("And how many of them?"))
