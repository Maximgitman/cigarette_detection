...
def run(weights=ROOT / 'custom_yolo5x.pt',  # model.pt path(s)
        ...
        name= "_out",  # save results to project/name
    ...
    # (save_dir / '_out' if save_txt else save_dir).mkdir(parents=True, exist_ok=True)  # make dir
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'custom_yolo5x.pt', help='model path(s)')
